...
class broshcrm_Bootstrap
{
    ...
    public  function my_menu($file1)
    {
        ...
        $page_title = esc_html__("BROSH CRM", 'brosh-crm');
        $menu_title = esc_html__("BROSH CRM", 'brosh-crm');
    ...
    function admin_page()
    {
		...
		$btn1 = __("Open BROSH inside wordpress", 'brosh-crm');
        $btn1_title = __("Open BROSH inside an iframe", 'brosh-crm');
		 $btn2 = __("Open BROSH in a new tab", 'brosh-crm');
        $btn2_title = __("Open BROSH as a new page / tab", 'brosh-crm');
		$wellcomeMSG0= __("Welcome to BROSH CRM Admin Dashboard!", 'brosh-crm');
$wellcomeMSG = __(" Where would you like to open BROSH CRM, inside wordpress or as a new tab?", 'brosh-crm');
$wellcomeMSG2 = __("The following will either create a new BROSH account for you or automatically log you into your existing account", 'brosh-crm');
    ?><div id="BROSHCRMIFRMWRP" >
	<br><br><br><br>
	<h2><?php echo esc_html($wellcomeMSG0)?></h2><br>
	<?php echo esc_html($wellcomeMSG)?><br>
	<?php echo esc_html($wellcomeMSG2)?><br><br>
	<button  onclick='openBROSH("<?php echo (esc_html($crm_url)) ?>",false);' title="<?php echo esc_html($btn1_title)?>" id="openBROSH0"><?php echo esc_html($btn1)?></button>
	<button onclick='openBROSH("<?php echo (esc_html($crm_url)) ?>",true);' title="<?php echo esc_html($btn2_title)?>" id="openBROSH1"><?php echo esc_html($btn2)?></button>
	</div><?php
